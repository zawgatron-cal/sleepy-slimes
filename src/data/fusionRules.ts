...
export const FUSION_RULES_MASTER: FusionRule[] = [
  ...
  { parentSpeciesA: SPECIES.MOON_SLIME.id, parentSpeciesB: SPECIES.BERRY_SLIME.id, resultSpeciesId: SPECIES.BAT_SLIME.id, candyCost: COSTS.FUSE_RARE, deterministic: true, weight: null },
